 ...
 * @author Dell
 */
public class Recibo extends Trabajadores {
    ...
    public Recibo(String nombre, String apellido, int identificacion, String direccion, int edad, String formacionAcademica, int añosExperiencia, int horas_trabajadas,
